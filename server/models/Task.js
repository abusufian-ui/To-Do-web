...
const TaskSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true }, // The Task Creator
  ...
  isDeleted: { type: Boolean, default: false }, // Master deletion flag (Creator side)
